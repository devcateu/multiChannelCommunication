...
$PEER1_EXEC peer chaincode instantiate -n $CHAINCODE_RING -v 1.0 -l "node" -c '{"function":"instantiate","Args":[]}' -C $CHANNEL_ONE_NAME -P "OR('Org1MSP.peer', 'Org2MSP.peer', 'Org3MSP.peer')" -o orderer.example.com:7050 --tls --cafile $ORDERER_TLS_CERT
$PEER1_EXEC peer chaincode instantiate -n $CHAINCODE_RING -v 1.0 -l "node" -c '{"function":"instantiate","Args":[]}' -C $CHANNEL_TWO_NAME -P "OR('Org1MSP.peer', 'Org2MSP.peer')" -o orderer.example.com:7050 --tls --cafile $ORDERER_TLS_CERT
$PEER1_EXEC peer chaincode instantiate -n $CHAINCODE_ZING -v 1.0 -l "node" -c '{"function":"instantiate","Args":[]}' -C $CHANNEL_ONE_NAME -P "OR('Org1MSP.peer', 'Org2MSP.peer', 'Org3MSP.peer')" -o orderer.example.com:7050 --tls --cafile $ORDERER_TLS_CERT
sleep 3

# invoke & query CHANNEL 1
$PEER1_EXEC peer chaincode invoke -C $CHANNEL_ONE_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:put", "slawomir", "1000"]}' --tls --cafile $ORDERER_TLS_CERT
sleep 3
echo "1: "
$PEER1_EXEC peer chaincode query -C $CHANNEL_ONE_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:get", "slawomir"]}' --tls --cafile $ORDERER_TLS_CERT
echo "2: "
$PEER2_EXEC peer chaincode query -C $CHANNEL_ONE_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:get", "slawomir"]}' --tls --cafile $ORDERER_TLS_CERT
echo "3: "
$PEER3_EXEC peer chaincode query -C $CHANNEL_ONE_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:get", "slawomir"]}' --tls --cafile $ORDERER_TLS_CERT

# invoke & query CHANNEL 2
$PEER1_EXEC peer chaincode invoke -C $CHANNEL_TWO_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:put", "devcat", "flying cat"]}' --tls --cafile $ORDERER_TLS_CERT
sleep 3
echo "1: "
$PEER1_EXEC peer chaincode query -C $CHANNEL_TWO_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:get", "devcat"]}' --tls --cafile $ORDERER_TLS_CERT
echo "2: "
$PEER2_EXEC peer chaincode query -C $CHANNEL_TWO_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:get", "devcat"]}' --tls --cafile $ORDERER_TLS_CERT
echo "3: "
$PEER3_EXEC peer chaincode query -C $CHANNEL_TWO_NAME -n $CHAINCODE_RING -c '{"Args":["com.devcat.keyvalue:get", "devcat"]}' --tls --cafile $ORDERER_TLS_CERT


# invoke & query CHANNEL 1 chaincode 2
$PEER1_EXEC peer chaincode invoke -C $CHANNEL_ONE_NAME -n $CHAINCODE_ZING -c '{"Args":["com.devcat.keyvalue:put", "sml", "1000"]}' --tls --cafile $ORDERER_TLS_CERT
sleep 3
echo "1: "
$PEER1_EXEC peer chaincode query -C $CHANNEL_ONE_NAME -n $CHAINCODE_ZING -c '{"Args":["com.devcat.keyvalue:get", "sml"]}' --tls --cafile $ORDERER_TLS_CERT
echo "2: "
$PEER2_EXEC peer chaincode query -C $CHANNEL_ONE_NAME -n $CHAINCODE_ZING -c '{"Args":["com.devcat.keyvalue:get", "sml"]}' --tls --cafile $ORDERER_TLS_CERT
echo "3: "
$PEER3_EXEC peer chaincode query -C $CHANNEL_ONE_NAME -n $CHAINCODE_ZING -c '{"Args":["com.devcat.keyvalue:get", "sml"]}' --tls --cafile $ORDERER_TLS_CERT
